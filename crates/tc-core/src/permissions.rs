...
pub trait Approval: Send + Sync { fn approve(&self, request: &ApprovalRequest) -> Result<bool>; }

#[derive(Clone, Debug, Default)]
pub struct PermissionPolicy { always_allowed: BTreeSet<Capability>, pub assume_yes: bool }
